  ...
  <section id="work" name="work">
    ...
    <div class="container desc">
      <div class="row">
        ...
        <div class="col-lg-6">
          <p><img class="img-responsive" src="<c:url value='/resources/bootstrap/kelvin/img/port01.jpg'/>" alt=""></p>
        </div>
        <div class="col-lg-3">
        ...
        <div class="col-lg-6 col-lg-offset-3">
          <p><img class="img-responsive" src="<c:url value='/resources/bootstrap/kelvin/img/port02.jpg'/>" alt=""></p>
        </div>
        <div class="col-lg-3">
          <p>SANKEY</p>
          <p>
        ...
        <div class="col-lg-6 col-lg-offset-3">
          <p><img class="img-responsive" src="<c:url value='/resources/bootstrap/kelvin/img/port03.jpg'/>" alt=""></p>
        </div>
        <div class="col-lg-3">
          <p>WE GROW</p>
          <p>
